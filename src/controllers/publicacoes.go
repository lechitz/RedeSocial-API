...
//BuscarPublicacoes busca todas as publicações que apareceriam no feed do usuário
...
//CurtirPublicacao adiciona uma curtida na publicação específica
...
//DescurtirPublicacao remove uma curtida de uma publicação específica
